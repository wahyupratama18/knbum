...
const defaultTags = () => {
    ...
    tags.push(
        generateTags(
            'keywords',
            'KNB, Kemitraan Negara Berkembang, OIA, UM, Universitas Negeri Malang, The Learning University, Kampus Merdeka',
        )
    )
...
homeTags.push(
    generateTags(
        'description',
        'Home of Kemitraan Negara Berkembang'
    )
)
...
const router = createRouter({
    ...
    routes: [{
        ...
        component: Home,
        meta: {
            title: 'Home - Kemitraan Negara Berkembang',
            metaTags: homeTags
        }
    }, {
        path: '/apply',
